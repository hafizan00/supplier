...
<div class="row">
	<ul class="nav nav-pills">
		...
		<li role="presentation"><a href="checkout_index.php">Checkout</a></li>
	</ul>
</div>

<!-- <div class="login-page" style="padding-top: 360px;">

  <div class="login-box">
    <div class="text-center">
      <h3 style="color:#fff ;">MY Supplier</h3>
...
<footer>
	<p>
		...
		- Affiliate marketing for student business portal
	</p>
</footer>
