    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form method="post" action="edit_account.php?id=<?php echo (int)$user['id']; ?>" class="clearfix">
          ...
          <div class="form-group">
            <label for="code" class="control-label">Referal Code</label>
            <input type="code" class="form-control" disabled name="code" value="<?php echo remove_junk(ucwords($user['code'])); ?>">
          </div>
